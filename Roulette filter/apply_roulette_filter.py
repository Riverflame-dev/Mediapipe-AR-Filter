...
filters_config = {
    ...
    #      'morph': False, 'animated': False, 'has_alpha': True}],
    'skybridge':
        [{'path': "filters/Skybridge.png",
          'anno_path': "filters/skybridge_annotations.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
    'cafeteria':
        [{'path': "filters/Cafeteria.png",
          'anno_path': "filters/cafeteria_annotations.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
    'ECTS':
        [{'path': "filters/ETCS.png",
          'anno_path': "filters/ETCS_annotations.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
    'home':
        [{'path': "filters/Home.png",
          'anno_path': "filters/home_annotations.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
    'kettler':
        [{'path': "filters/Kettler.png",
          'anno_path': "filters/kettler_annotations.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
    'library':
        [{'path': "filters/Library.png",
          'anno_path': "filters/library_annotations.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
}
